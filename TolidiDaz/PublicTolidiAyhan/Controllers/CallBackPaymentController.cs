        ...
        public async Task<IActionResult> Authority(string Res = "")
        {
            ...
            try
            {
                if (Request.HasFormContentType)
                {
                    ...
                    var enumstate= (EnumPaymentSepStatuseResponse)paymentResponse.Status;
                     if (enumstate != EnumPaymentSepStatuseResponse.OK)
                        return Redirect($"{failUrlBase}&Message={GetMessagePaymentSepStatuseResponse(enumstate)}");
