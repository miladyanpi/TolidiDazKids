...
//namespace PublicTolidiAyhan.Pages.Payment
//{
//    [IgnoreAntiforgeryToken]
//    //[Authorize(Roles = ConstantRoles.CustomerName)]
//    public class AuthorityModel : PageModel
//    {
//        private readonly IRootApi<ResponseApiEntity<PaymentSepResult>> _RootApiResponseTokenSep;
//        private readonly IRootApi<ResponseApiEntity<SearchOrderPaymentTemp>> _RootApiSearchOrderPaymentTemp;

//        public AuthorityModel(TokenServiceServer tokenService, IRootApi<ResponseApiEntity<PaymentSepResult>> RootApiResponseTokenSep,
//            IRootApi<ResponseApiEntity<SearchOrderPaymentTemp>> RootApiSearchOrderPaymentTemp)
//        {
...
//                    };
//                    var resdataOrderPaymentTemp = await _RootApiSearchOrderPaymentTemp.RunMethodApi($"OrderPaymentTemps", searchOrderPaymentTemp, method: Method.Post);
//                    if (resdataOrderPaymentTemp.Status == ResultMessageApi.Success)
//                    {
//                        var resdata = await _RootApiResponseTokenSep.RunMethodApi($"Payments/Sep/Public/Verify", paymentResponse, method: Method.Post);//, Token: resdataOrderPaymentTemp.Entity.Token
