...
namespace PublicTolidiAyhan.Code
{
    public class Methods
    {
        ...
        //{
        //    var token = GetToken();
        //    return await IRootApi<ResponseApiEntity<ResultGroupRenovation>>.RunMethodApi($"GroupRenovations/GetForView/{GroupRenovationID}", null, method: Method.Get, token);

        //}
        //private async Task<ResponseApiEntity<UpdateYear>> GetYear(int YearID)
        //{
        //    var token = GetToken();
        //    return await IRootApi<ResponseApiEntity<UpdateYear>>.RunMethodApi($"Years/{YearID}", null, method: Method.Get, token);
        //}
        ...
        //{
        //    var token = GetToken();
        //    return await IRootApi<ResponseApiEntity<UpdateBasicInformationPerYear>>
