...
namespace DAL.Context
{
    public interface IRepository<TEntity> where TEntity : class
    {
        ...
        Task<List<int>> AddRangeAsync(List<TEntity> entities);
       ...
       Func<IGrouping<TGroup, TResult>, TReturn> selector);
        ...
        Task<IEnumerable<TResult>> GetAllAsync<TResult>(Expression<Func<TEntity, bool>> predicate, Expression<Func<TEntity, TResult>> selector, int page, int take);
        Task<IEnumerable<TResult>> GetAllAsync<TResult>(Expression<Func<TEntity, TResult>> selector, int page, int take);
        ...
        Task<TValue?> GetMaxAsync<TValue>(Expression<Func<TEntity, TValue>> selector)
       where TValue : struct, IComparable;
        Task<TValue?> GetMaxAsync<TValue>(
        Expression<Func<TEntity, bool>> predicate,
        Expression<Func<TEntity, TValue>> selector)
        where TValue : struct, IComparable;
        Task<IEnumerable<TEntity>> GetTopAsync<TOrderKey>(Expression<Func<TEntity, TOrderKey>> orderByDesc,int take);
        Task<IEnumerable<TEntity>> GetTopAsync<TOrderKey>(Expression<Func<TEntity, TOrderKey>> orderByDesc, Expression<Func<TEntity, bool>> predicate, int take);
    }
