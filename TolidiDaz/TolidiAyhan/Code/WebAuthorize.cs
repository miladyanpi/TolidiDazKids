//using TolidiAyhan.Models.Const;
...
//            var Login = await (new RootApi<ResponseApiEntity<ResultExpiredToken>>(_,httpContextAccessor)).RunMethodApi($"auth/CheckExpiredToken?Token={stringToken}", null, method: Method.Get);
